    ...
    <section className="team-hero">
      ...
      <div className="team-hero-content shell">
        ...
        <p className="team-hero-desc">
          六只各怀绝技的 AI 代理猫，协同作战，从架构设计到安全防护，从前端美化到数据洞察——
          没有什么任务是猫猫天团搞不定的。
        </p>
        <div className="team-hero-cta">
          <a className="btn-primary" href="https://github.com/HKUDS/ClawTeam" target="_blank" rel="noreferrer">
            加入天团
          </a>
          <a className="btn-ghost" href="#team-members">认识成员</a>
        </div>
      </div>
    </section>
  );
