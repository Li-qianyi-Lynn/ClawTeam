...
export const TEAM_MEMBERS = [
  {
    ...
    personality: "霸气果断，总览全局，关键时刻镇定自若，对团队充满责任感",
    skills: ["任务拆解", "团队协调", "战略规划", "进度管控"],
    tags: ["领导", "战略", "协调"],
    color: "#f97316",
  },
  {
    ...
    personality: "严谨细腻，追求完美，善于抽象思维，沉默寡言但发言必中要害",
    skills: ["系统架构设计", "React", "模块拆分", "接口规范"],
  ...
  },
  {
    ...
    personality: "务实低调，稳如磐石，喜欢深挖问题根源，对数据一丝不苟",
    skills: ["Python", "REST API", "数据库设计", "Vite 构建配置"],
    tags: ["Python", "API", "数据库"],
    color: "#22c55e",
  },
  {
    ...
    personality: "充满创造力，感性细腻，极具审美品味，热衷于打磨每一个视觉细节",
    skills: ["UI 设计", "CSS 动画", "用户体验", "响应式布局"],
    tags: ["UI设计", "动画", "用户体验"],
    color: "#ec4899",
  },
  {
    ...
    personality: "谨慎多疑（褒义），原则性极强，绝不放过任何安全隐患",
    skills: ["安全审计", "漏洞扫描", "代码审查", "CSP 配置"],
    tags: ["安全审计", "漏洞扫描", "代码审查"],
    color: "#3b82f6",
  },
  {
    ...
    personality: "理性冷静，善于发现规律，用数字讲故事，对成本精打细算",
    skills: ["数据分析", "可视化", "Token 成本监控", "效率报告"],
    tags: ["数据分析", "可视化", "监控"],
    color: "#a855f7",
  },
];
